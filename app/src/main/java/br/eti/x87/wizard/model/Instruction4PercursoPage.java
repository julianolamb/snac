...
import br.eti.x87.wizard.ui.Instruction4PercursoFragment;

public class Instruction4PercursoPage extends Page {

    protected ArrayList<String> mChoices = new ArrayList<String>();

    public Instruction4PercursoPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return Instruction4PercursoFragment.create(getKey());
    }
    ...
    public Instruction4PercursoPage setValue(String value) {
